...
function SectionTitle({ children }: { children: React.ReactNode }) {
  return <h3 className="text-lg font-semibold text-white/90">{children}</h3>;
}
...
function DateInput({
  ...
  return (
    <div className="flex flex-col w-full">
      <label className="text-xs text-white/70 mb-1">{label}</label>
      <input
        type="date"
        className="w-full px-3 py-2 bg-white/5 text-white
