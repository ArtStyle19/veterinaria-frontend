...
const handleDownloadQR = async () => {
  ...
  async function handleImport() {
    ...
    try {
      ...
      toast.success(
        role === 'VET' ? 'Paciente importado con éxito' : 'Mascota importada con éxito'
      );
      navigate('/pets');
    } catch (err: any) {
  ...
  return (
    <section className="md:w-2/3 mx-auto px-4 py-8 text-white">
      <div className="max-w-2xl mx-auto bg-white/5 p-6 rounded-2xl shadow-lg backdrop-blur-md border border-white/10">
        ...
        <div className="flex flex-col items-center gap-6 text-center">
          ...
          <div className="flex flex-col items-center gap-3">
            <div className="p-3 rounded-full bg-yellow-400/20 border border-yellow-400/30">
              ...
              >
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.054 0 1.635-1.14 1.05-2.004L13.05 4.004c-.588-.864-1.863-.864-2.45 0L3.032 17.996c-.585.864-.004 2.004 1.05 2.004z" />
              </svg>
            </div>
            ...
            <p className="text-sm text-white/60 max-w-md">
              Si reconoces a esta mascota, por favor contacta al propietario.
            </p>
          </div>
          ...
          <div className="pt-2 w-full max-w-md">
            <button
              onClick={() => {
                toast.success('Ubicación enviada al propietario');
              }}
            ...
            >
              ...
              {pet.canBeImported && (
                <tr className="border-y border-green-500/20 bg-green-500/5">
                  <td colSpan={2} className="px-6 py-4 text-green-300 text-sm text-center">
  ...
  >
    ...
    Descargar QR
      ...
      <div className="mt-6 text-center">
        <Link
          to="/"
          className="inline-block px-4 py-2 rounded-lg bg-white/10 hover:bg-white/20 border border-white/20 text-white text-sm font-medium transition"
        >
          Volver al inicio
        </Link>
      </div>
