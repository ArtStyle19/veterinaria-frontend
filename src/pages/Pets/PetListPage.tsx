        ...
        <div className="space-y-6">
          <section className="bg-white/5 shadow rounded p-4 space-y-4">
            ...
            <table className="min-w-full table-auto text-sm text-white">
              <thead>
                <tr className="bg-white/10 border-b border-white text-xs uppercase tracking-wide">
              ...
              <tbody>
                {pets.map((p, i) => (
                  ...
                  >
                    ...
                    ${p.status === 'OK' ? 'bg-emerald-800/20 text-emerald-200' : ''}
                    ${p.status === 'LOST' ? 'bg-red-800/20 text-red-200' : ''}
